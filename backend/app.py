...
textos_positivos_escuela = [
    ...
    'Los proyectos en equipo me han enseñado a colaborar a distancia.',
    'Es una institución que realmente cumple lo que promete.',
    'La diversidad de mis compañeros enriquece mucho los debates.',
...
textos_negativos = [
    ...
    'No hay un seguimiento real a los estudiantes con riesgo de deserción.',
